...
<body>
    <form name="aspnetForm" method="post" action="brand.aspx?brand=Siboney" id="aspnetForm">
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="A91F14A3" />
	    ...
	    <div class="top-graphic">
          ...
          <div style="position:absolute;right:0px;top:10px"> 
              ...
              <a href="/login.aspx?ReturnUrl=http:%2f%2fwww.cubancigarwebsite.com%2fbrand.aspx%3fbrand%3dSiboney ">Sign In</a> | <a href="/signup.aspx">Register</a>
